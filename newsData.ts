...
const newsData: Map<string, NewsEntry> = new Map([
  ['2023-04-01', {
    id: '1',
    date: '2023-04-01',
    title: 'New AI breakthroughs announced',
    content: 'Multiple tech companies present revolutionary AI technologies'
  }],
  ['2023-04-02', {
    id: '2',
    date: '2023-04-02',
    title: 'New space telescope delivers first images',
    content: 'Spectacular photos of distant galaxies published'
  }]
])